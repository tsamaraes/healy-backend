"""
Django settings for healy project.
...
SECRET_KEY = 'django-insecure-7+!-z(uf3*e9hs)n04t=sd=-$8xjek9!3vm=qvy1e7hl^p1bcr'
...
WSGI_APPLICATION = 'healy.wsgi.application'
